    ...
    let _self = this;
        ...
        this.appService.cntAppFromLogin.pipe(takeWhile(() => this.isAlive)).subscribe(info => {
         ...
         //  console.log(this.appService.account_info);
          ...
          this.timer.pipe(takeWhile(() => this.isAlive))
          .subscribe(info =>{
        ...
        //  })
            this.appService.GET_METHOD(this.appService.route.api.gUConfig + this.appService.account_info.user_id).subscribe((response:any) => {
              ...
              // console.log(response);
                ...
                let proposedRoute = (this.appService.hisotryRoute) ? this.appService.hisotryRoute : "ticket/dashboard";

                  this.appService.hisotryRoute = "";
                  setTimeout(() => {
                    _self.toolBarOnOff = info.toolbar_on;
                      ...
                      _self.router.navigateByUrl(proposedRoute);
